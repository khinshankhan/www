...
import { GridPattern } from "@/components/design-system/patterns/decorations/grid-pattern"
import { Button } from "@/components/design-system/primitives/button"
import { Link } from "@/components/design-system/primitives/link"
import { H1, H2, Paragraph, Text } from "@/components/design-system/primitives/text"
  ...
  return (
    <AppShell>
      <div className="relative pb-24">
        <section className="maxw-page mx-auto mt-8 flex flex-col items-center justify-center space-y-12 md:mt-20">
          <GridPattern
            primaryPattern
            secondaryPattern
            size="sm"
