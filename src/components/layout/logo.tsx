...
export function Logo({
  ...
  return (
    <svg
      ...
      style={{ display: "block" }}
      className={cn(
        "shadow-foreground group-hover:shadow-accent-8 group-hover:focus:shadow-accent-8 shadow-[0px_0px_10px_1px] transition-all duration-300 ease-in-out",
        className
      )}
      {...props}
    >
      ...
      <path
        className={cn(
          "transition-stroke group-hover:stroke-accent-11 fill-none stroke-transparent duration-500 ease-in-out",
          borderClassName
        )}
        strokeWidth={20}
