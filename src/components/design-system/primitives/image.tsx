    ...
    <Wrapper>
      <img
        ...
        className={cn(
          ...
          "border-muted mx-auto aspect-[var(--data-width)/var(--data-height)] max-h-[725px] max-w-full rounded-lg border backdrop-blur-none data-[loading=true]:animate-pulse data-[loading=true]:bg-background-1/60 data-[loading=true]:backdrop-blur-xs",
          className
        )}
        style={{
          ...aspectRatioStyles,
