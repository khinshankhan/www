  ...
  return (
    ...
    >
      <Text>
        ...
        professionally and for fun. I'm passionate about just having a good time, and if that helps
        someone else, it'd be pretty neat. Feel free to take a gander at some of my{` `}
      ...
      <Text>
        ...
        colleagues, unless stated explicitly, my writing and opinions <i>should not</i> be
        considered
        {` `}
      ...
      <Text>
        ...
        not under MIT licensing (tldr: cite me if you use my words, would be cool if you mentioned
        me somewhere when you use my code too 😛).
      </Text>

      <Text>
        I’ve been discontent with my website, I must’ve changed it 10+ times now. After
        experimenting from vanilla to{` `}
        <ExternalLink href="https://github.com/sintaxi/harp">Harp</ExternalLink> to
        {` `}
        <ExternalLink href="https://github.com/Frozen-Flask/Frozen-Flask">
          Frozen Flask
        </ExternalLink>
        {` `}
        to <ExternalLink href="https://github.com/jekyll/jekyll">Jekyll</ExternalLink> etcetera
        etcetera, I've realized what I should use is what I feel most comfortable with and similar
        to what I use for work. Hopefully using modern technologies will make this full on rewrite
        the last rewrite for years on end. I've named it anchorage to keep me anchored… hopefully
        😳.
      </Text>

      <Text>
        I don't intend on making this a reusable template easy for anyone to use at the moment, but
        I{` `}
      ...
      <Text>
        The stack is <ExternalLink href="https://pnpm.io/">pnpm</ExternalLink> to manage
        dependencies,
        {` `}
        <ExternalLink href="https://www.gatsbyjs.com/">Gatsby</ExternalLink> for the static site
        generation framework, <ExternalLink href="https://chakra-ui.com/">Chakra UI</ExternalLink>
        {` `}
        for the styling, and <ExternalLink href="https://www.netlify.com/">Netlify</ExternalLink> to
        host.
      </Text>
