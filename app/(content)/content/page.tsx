...
export default async function Page() {
  return (
    ...
    >
      ...
      <p>
        The <Strong>Golden Ratio</Strong> is a <Em>mathematical ratio</Em> that is commonly found in{" "}
        <Strong>
          <Em>nature</Em>
        </Strong>
      ...
      <p>
        ...
        paragraph about it. Even though I could have written about anything else, I chose ice cream.
        I like it that much. This page's title is "Icecream Lorem Ipsum" after all. So here's a
        paragraph about ice cream. I hope you like it. Enjoy!
      </p>
