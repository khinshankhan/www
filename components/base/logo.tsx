...
export function Logo({
  ...
  return (
    <svg
      ...
      style={{ display: "block" }}
      className={cn(
        "shadow-[0px_0px_10px_1px_var(--color-foreground)] transition-all duration-300 ease-in-out group-hover:shadow-[0px_0px_10px_1px_var(--color-accent-link)] focus:group-hover:shadow-[0px_0px_10px_1px_var(--color-accent-link)]",
        className
      )}
      {...props}
    >
      <rect className="logo-bg" width="100%" height="100%" fill={bgColor} />
      <path
        className="logo-fg transition-transform duration-500 ease-in-out group-hover:-translate-x-12 group-hover:-translate-y-12 group-hover:scale-125 group-focus:-translate-x-12 group-focus:-translate-y-12 group-focus:scale-125"
        fill={fgColor}
      ...
      />
      <path
        className="logo-border transition-stroke stroke-transparent duration-500 ease-in-out group-hover:stroke-accent-link group-focus:stroke-accent-link"
        fill="none"
        stroke={borderColor}
        strokeWidth={20}
