...
export const Logo = ({
  ...
  <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 460 460">
    ...
    />
    <path fill="none" stroke={borderColor} strokeWidth={20} d="M10 10h440v440H10z" />
  </svg>
);

interface ILogoButtonProps extends ILogoProps {
  size?: number;
}
// TODO: turn this into chakra icon button
export const LogoButton = ({ size = 460, ...props }: ILogoButtonProps) => (
